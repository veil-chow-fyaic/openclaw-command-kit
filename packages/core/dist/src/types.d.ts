...
export type SessionHiddenReason = 'actor_missing' | 'actor_account_mismatch' | 'actor_organization_mismatch' | 'missing_session_id' | 'missing_session_key' | 'provider_mismatch' | 'account_mismatch' | 'organization_mismatch' | 'chat_type_mismatch' | 'route_mismatch_untrusted' | 'low_signal_default' | 'query_filtered';
